...
class DatabaseService {
  ...
  Future <List<dynamic>> oldOrders() async{
  ...
  Future<void> addOrder(Cart cart) async {
    ...
    String id = _myTime.day.toString() + '_' + _myTime.month.toString() + '_' + _myTime.year.toString() + '_' + _myTime.hour.toString() + '_' + _myTime.minute.toString() + '_' + _myTime.second.toString() + '_' + cart.uid + '_';
  ...
  Future<Map> getOrderDetails(String orderUID, String shopUID, String status)async{
    DocumentSnapshot snapshot = await FirebaseFirestore.instance.collection('shops').doc(shopUID).collection(status).doc(orderUID).get();
